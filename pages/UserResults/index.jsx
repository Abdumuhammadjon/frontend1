...
const UserResults = () => {
  ...
  useEffect(() => {
    ...
    const fetchResults = async () => {
      ...
      try {
        ...
        const url = subjectId
          ? `https://60maktab.onrender.com/api/userResults/${userId}?subjectId=${subjectId}`
          : `https://60maktab.onrender.com/api/userResults/${userId}`;
  ...
  const handleDelete = async (resultId) => {
    ...
    try {
      await axios.delete(`https://60maktab.onrender.com/api/userResult/${resultId}`, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
